...
class VoiceScreen extends StatelessWidget {
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (state is VoiceIdle || state is VoiceError) ...[
                          TextButton.icon(
                            onPressed: () => _showManualInputDialog(context),
                            icon: const Icon(Icons.keyboard_outlined, size: 18),
                            label: const Text('Type Command Manually'),
  ...
  void _showManualInputDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Text('Enter Command Manually', style: AppTheme.titleMedium),
        content: TextField(
          controller: controller,
          style: AppTheme.bodyMedium,
          decoration: const InputDecoration(
            hintText: 'e.g. pitch to 15 yaw to -25',
            hintStyle: TextStyle(color: AppTheme.onSurfaceLow),
          ),
          autofocus: true,
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (text.isNotEmpty) {
                context.read<VoiceBloc>().add(VoiceManualCommandSubmitted(text));
              }
  ...
  String _stateLabel(VoiceState state) => switch (state) {
        ...
        VoiceTranscribing()       => 'Transcribing with OpenAI Whisper…',
